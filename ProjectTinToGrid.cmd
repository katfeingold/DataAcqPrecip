...
::: This batch file is a template for the ProjectTinToGrid MetVue utility.
...
::: Location of the HEC-MetVue package
set MV_HOME=../..
...
set class_path=-cp "%MV_HOME%/metvue/modules/*;%MV_HOME%/metvue/modules/ext/*;%MV_HOME%/platform/modules/*;%MV_HOME%/platform/lib/*;%MV_HOME%/platform/core/*;%APPDATA%/HEC/HEC-MetVue/3.4.1.419/user/*"
...
set main_method=hec/metvue/base/tin/spatialUtil/ProjectTinToGrid
